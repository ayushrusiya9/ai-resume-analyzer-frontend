...
export default function Navbar() {
    ...
    return (
        <nav className="w-full">
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between bg-white rounded-full shadow-2xl px-4 py-3 sm:px-6 sm:py-4 mt-4">
